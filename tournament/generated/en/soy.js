...
Pond.soy.visualization = function(opt_data, opt_ignored, opt_ijData) {
  return '<div id="visualization"><canvas id="scratch" width="400" height="400" style="display: none"></canvas><canvas id="display" width="400" height="400"></canvas></div><table id="avatarStatTable"><tbody><tr id="avatarStatRow1"></tr><tr id="avatarStatRow2"></tr></tbody></table><table width="400"><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button id="docsButton" disabled title="It\'s taking too long!">Timeout round</button></td><td><button id="runButton" title="Run the next round in tournament." disabled><img src="common/1x1.gif" class="run icon21"> Next round</button><button id="resetButton" class="primary" style="display: none" title="Stop the round and reset the level."><img src="common/1x1.gif" class="stop icon21"> Reset</button></td></tr><tr><td style="width: 190px; text-align: center; vertical-align: top;"><button id="startButton" class="secondary">Begin tournament</button></td><td><button id="scoreButton" disabled>Match score</button></td></tr></table><div id="dialogDocs"><img src="common/1x1.gif" class="close icon21" id="closeDocs"><iframe id="frameDocs"></iframe></div>';
};
if (goog.DEBUG) {
